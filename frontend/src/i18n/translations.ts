...
export const translations = {
  en: {
    ...
    adminPanel: {
      ...
      upgradeNoUpdates: 'No updates available',
    ...
    converter: {
      ...
      clearStructureHint: 'For the best result, documents should have a clear text structure (e.g., exported Word documents work better than complex PDF layouts).',
  ...
  es: {
    ...
    adminPanel: {
      ...
      upgradeNoUpdates: 'Sin actualizaciones',
    ...
    converter: {
      ...
      clearStructureHint: 'Para obtener el mejor resultado, los documentos deben tener una estructura de texto clara (por ejemplo, documentos de Word exportados funcionan mejor que diseños de PDF complejos).',
